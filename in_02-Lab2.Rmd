...
```{r, L2-Submit, echo=FALSE, fig.cap="Find them in your STAT462 folder on your computer", out.width="100%"}
...
```{r, L2-CloudDownload, echo=FALSE, fig.cap="How do download the files from PositCloud", out.width="100%"}
