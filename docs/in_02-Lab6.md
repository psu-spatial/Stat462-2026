...
-   **[9D]** What does the model predict as the average beak length for the penguin called Ella? I suggest typing out the equation in a code chunk?  Make sure to show your code/working. 
...
| Professional report (formatting, sentences, headings, spell check) | 15 |
| Steps 6–8: Data wrangling and EDA | 10 |
| Steps 9: Full model — equation, coefficients, Adj R² | 15 |
| Steps 10–12: LINE, outliers, multicollinearity | 15 |
| Steps 13–14: F-tests (overall and nested) | 10 |
| Steps 15: Best subsets and model selection | 15 |
| Step 16: Prediction | 10 |
| **Total** | **100** |
| Step 17 (Bonus) | up to 5 |
<br>
