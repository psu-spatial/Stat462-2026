...
```{r, fig.cap="The residuals show a clear parabolic pattern — a linear model is not appropriate here"}
...
```{r, fig.cap="Clear fanning — variance increases with fitted values"}
...
data2 <- read.csv("/Users/hgreatrex/Documents/GitHub/Teaching/STAT-462/Stat462-2026/index_data/leverage.csv")
data2b <- data2[-25,]
...
data2 <- read.csv("/Users/hgreatrex/Documents/GitHub/Teaching/STAT-462/Stat462-2026/index_data/influential.csv")
data2b <- data2[-25,]
