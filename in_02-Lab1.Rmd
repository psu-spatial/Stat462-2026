...
```{r, L1-Projectcheck, echo=FALSE, fig.cap="How to check you are in a project", out.width="100%"}
...
```{r, lb3Deletetext, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics('./index_images/T3_DeleteText.png')
```

-   **[5B]** Create a level 1 heading called "Questions"

```{r, lb3Deletetext2, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics('./index_images/L3B_Questions1.png')
```

The result should look like this

```{r, lb3Deletetext1, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics('./index_images/L3B_Questions2.png')
```
...
```{r, L1-Loadpackages, echo=FALSE, fig.cap="Type this exactly then run the code chunk. It will only work if you have first installed the packages from the appstore", out.width="100%"}
knitr::include_graphics('./index_images/im_L1_LoadPackages.png')
```
...
```{r, L1-ViewData, echo=FALSE, fig.cap="Type each line into the CONSOLE", out.width="100%"}
knitr::include_graphics('./index_images/im_L1_ViewData.png')
```
