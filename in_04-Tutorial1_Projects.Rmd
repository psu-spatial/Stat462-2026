...
```{r im-T1-Projectcreation1, echo=FALSE}
...
```{r im-T1-Projectcreation2, echo=FALSE}
...
```{r, im-T1-Projectcheck, echo=FALSE, fig.cap="How to check you are in a project"}
...
```{r, im-T1-Projectopen, echo=FALSE}
...
```{r, im-T1-Projectopeninside1, echo=FALSE}
knitr::include_graphics('./index_images/im_T1_Projectopen_inside1.png')
```
 
Or 

```{r, im-T1-Projectopeninside2, echo=FALSE}
