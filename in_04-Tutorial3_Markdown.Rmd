...
```{r im-T3-Rmdformats, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics('index_images/im_T3Rmdformats.png')
```
...
```{r im-T3-RmdformatsPlus, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics('index_images/im_T3RmdformatsPlus.png')
```
...
```{r im-T3-MoveLabReport, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics('index_images/im_T3MoveLabReport.png')
```        

    -   Then move up a level to your main lab 4, click the tickbox by the sub-folder and press delete.

```{r im-T3-DeleteFolder, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics('index_images/im_T3DeleteFolder.png')
```  
