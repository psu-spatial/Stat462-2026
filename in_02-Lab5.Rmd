...
AllData$Log_lake_Alkalinity <- log(AllData$lake_alkalinity)
model4 <- lm(fish_av_mercury~Log_lake_Alkalinity,data=AllData)
olsrr::ols_plot_resid_fit(model4)
olsrr::ols_plot_cooksd_chart(model4)
olsrr::ols_plot_resid_lev(model4)
```
...
```{r, L5-Submit, echo=FALSE, fig.cap="Find them in your STAT462 folder on your computer", out.width="100%"}
