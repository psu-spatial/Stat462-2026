...
```{r, im-T1-ProjectCloud, echo=FALSE, fig.cap = "*The Cloud dashboard*",out.width='90%',fig.align='center'}
...
```{r,im-T1-StartupLogos, echo=FALSE, out.width="80%",fig.align='center'}
...
```{r im-T1-Projectcreation1, echo=FALSE,out.width="100%"}
knitr::include_graphics('./index_images/im_T1_Projectcreation1.png')
```

5.  You will be asked to find your Lab 1 folder on your computer. Find it and click open,

```{r im-T1-Projectcreation2, echo=FALSE,out.width="100%"}
knitr::include_graphics('./index_images/im_T1_Projectcreation2.png')
```
...
```{r, im-T1-Projectcreation3, echo=FALSE}
knitr::include_graphics('./index_images/im_T1_Projectcreation3.png')
```
...
```{r, im-T1-Projectcheck, echo=FALSE, fig.cap="How to check you are in a project",out.width="100%"}
...
```{r, im-T1-Projectopen, echo=FALSE,out.width="100%"}
...
```{r, im-T1-Projectopeninside1, echo=FALSE,out.width="100%"}
knitr::include_graphics('./index_images/im_T1_Projectopen_inside1.png')
```
 
Or 

```{r, im-T1-Projectopeninside2, echo=FALSE,out.width="100%"}
knitr::include_graphics('./index_images/im_T1_Projectopen_inside2.png')
```
